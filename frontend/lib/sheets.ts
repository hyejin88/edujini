...
const COMP_UNITS: Record<string, { title: string; subtitle: string }> = {
  ...
  "math-2-1-3": { title: "단원 학습", subtitle: "두 자리 수 받아올림·받아내림 · 20문제" },
  "math-2-1-6": { title: "단원 학습", subtitle: "곱셈 입문 — 묶어 세기·같은 수 더하기 · 20문제" },
  "math-2-2-2": { title: "단원 학습", subtitle: "곱셈구구 (2~9단) · 20문제" },
  "math-5-1-2": { title: "단원 학습", subtitle: "약수와 배수·최대공약수·최소공배수 · 20문제" },
  "math-5-1-5": { title: "단원 학습", subtitle: "분모 다른 분수의 덧·뺄셈 · 20문제" },
